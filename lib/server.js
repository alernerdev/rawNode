    ...
    req.on('end', function () {
        ...
        try {
            ...
            server.processHandlerResponse(
                res, method, trimmedPath, 500, {'Error' : 'An unknown error has occurred'}, 'json' 
            );
        }
    });
};
...
server.processHandlerResponse = function processHandlerResponse(res, method, trimmedPath, statusCode, payload, contentType) {
